...
export const sendAddedVacationEmail = async (vacation: Vacation) => {
    ...
    userData?.patronymic
            ...
            <div style="background-color: #0070ff; cursor: pointer; width: fit-content; padding: 10;  border-radius: 6px;">
                <a href="https://vacation-plus.netlify.app/vacations/${
    vacation._id
}" style="text-decoration: none; color: white;">Перейти в сервис</a>
            </div>
        </div>
    `;
